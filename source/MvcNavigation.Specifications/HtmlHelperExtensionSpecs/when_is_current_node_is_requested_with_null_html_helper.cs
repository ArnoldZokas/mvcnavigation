...
namespace MvcNavigation.Specifications.HtmlHelperExtensionSpecs
{
	...
	public class when_is_current_node_is_requested_with_null_html_helper : action_link_spec
	{
		static Exception exception;

		Because of = () => exception = Catch.Exception(() => HtmlHelperExtensions.IsCurrentNode(null, new Node<TestController>(c => c.Action1())));
